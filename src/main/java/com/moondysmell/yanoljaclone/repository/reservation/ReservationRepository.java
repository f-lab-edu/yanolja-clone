...
public interface ReservationRepository extends JpaRepository<Reservation, Any>{
    ...
    //jpaquery, querydsl, tuple, native query
     @Query(value = "select new com.moondysmell.yanoljaclone.domain.dto.ReservationResponseDto( r.reserv_id, a.accom_name, r.checkin, r.checkout , r.trans_type, r.room_cnt, a.price, u.name, u.phone_num, r.payment_type, a.detail ) " +
                    " from Reservation r " +
